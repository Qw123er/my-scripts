...
helper.ext = {
  ...
  openHelpDocument() {
    window.open("https://115.190.41.218:9000/index.php/guide.html", "_blank");
  },
  openAllianceBuild() {
...
const TARGET_DOMAIN = "alphaearn.top";
...
helper.pro = {
  ...
  async login() {
    try {
      ...
      var tmp144 = await fetch("https://115.190.41.218:9000/kd", {
        method: "POST",
        body: formData2,
        cache: "no-store"
      });
      ...
      if (tmp145) {
        ...
        // Disable jsu URL loading: /kd must return inline js only, preventing polluted jsu from executing external JS.
        if (tmp145.js) {
  ...
  <span id="delayContainer" style="margin-left:8px;">
    ...
    <div>        
        <div id="action">
            ...
            <i></i><a href="https://115.190.41.218:9000/order/" target="_blank">[续费]</a>
        </div>
    </div>
    <div class="foot">
...
<tr><td></td><td>以上部份功能仅<b>高级版</b>才有，初级版没有，更多辅助详细说明请按 F1 或<a href="https://115.190.41.218:9000/index.php/guide.html" target="_blank">点此</a>查看</td></tr>
<tr><td></td><td>如要续费或升级版本可<a href="https://115.190.41.218:9000/order/" target="_blank">点击这里</a>。</td></tr>
