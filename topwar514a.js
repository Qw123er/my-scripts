...
helper.ext = {
  ...
  openHelpDocument() {
    window.open("https://alphaearn.top/index.php/guide.html", "_blank");
  },
  openAllianceBuild() {
...
helper.pro = {
  ...
  async login() {
    try {
      ...
      var tmp144 = await fetch("https://alphaearn.top/kd", {
        method: "POST",
        body: formData2,
        cache: "no-store"
      });
  ...
  <span id="delayContainer" style="margin-left:8px;">
    ...
    <div>        
        <div id="action">
            ...
            <i></i><a href="https://alphaearn.top/order/" target="_blank">[续费]</a>
        </div>
    </div>
    <div class="foot">
...
<tr><td></td><td>以上部份功能仅<b>高级版</b>才有，初级版没有，更多辅助详细说明请按 F1 或<a href="https://alphaearn.top/index.php/guide.html" target="_blank">点此</a>查看</td></tr>
<tr><td></td><td>如要续费或升级版本可<a href="https://alphaearn.top/order/" target="_blank">点击这里</a>。</td></tr>
